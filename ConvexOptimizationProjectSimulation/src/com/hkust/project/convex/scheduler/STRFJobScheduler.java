...
public class STRFJobScheduler extends JobScheduler{
	...
	public  Map<Integer, Job> assignJob(List<Job> jobs, List<Server> servers) {
		Collections.sort(jobs, new Comparator<Job>() {
			...
			public int compare(Job arg0, Job arg1) {
				return (arg0.deadline-arg0.arrivalTime)*1.0/arg0.workload > (arg1.deadline-arg1.arrivalTime)*1.0/arg1.workload ? 1 : (arg0.deadline-arg0.arrivalTime)*1.0/arg0.workload < (arg1.deadline-arg1.arrivalTime)*1.0/arg1.workload ? -1 : 0;
			}
		});
